...
# Colors of the blocks: Vert, Jaune, Bleu, Noir
shapeColors = [(0, 255, 0), (255, 255, 0), (0, 0, 255), (0, 0, 0), (255, 165, 0), (0, 0, 255), (128, 0, 128)]
...
def startGame():
    ...
    while not done:
        ...
        text_game_over = font.render("Vous Avez Perdu", True, '#000000')
        text_game_over1 = font.render("Appuyez ESC/Echap", True, '#000000')

        # Ending the game if state is gameover
        screen.blit(text, [300, 0])
        if game.state == "vous avez perdu":
...
pygame.display.set_caption("Mona Technology Tetris Game")
run = True
while run:
    screen.fill((16, 57, 34))
    font = pygame.font.SysFont("Calibri", 70, bold=True)
    label = font.render("Appuyez sur une touche", True, '#FFFFFF')
